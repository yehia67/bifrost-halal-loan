...
pub mod pallet {
    ...
    use polkadot_sdk::{
        ...
        sp_runtime::{
            traits::{AccountIdConversion, AtLeast32BitUnsigned, SaturatedConversion},
    ...
    pub type LoanPositionOf<T> =
        LoanPosition<<T as polkadot_sdk::frame_system::Config>::AccountId, <T as Config>::LoanId>;
    ...
    pub enum Event<T: Config> {
        ...
        RewardsAdded { loan_id: T::LoanId, amount: Balance },
    ...
    impl<T: Config> Pallet<T> {
        ...
        pub fn create_loan(
            ...
            let collateral_value =
                Self::get_collateral_value(collateral_vtoken, collateral_amount, loan_currency)?;
        ...
        pub fn liquidate_loan(origin: OriginFor<T>, loan_id: T::LoanId) -> DispatchResult {
            ...
            let ltv = Self::calculate_ltv(loan_id)?;
                ...
                ltv >= T::LiquidationThreshold::get(),
                Error::<T>::CannotLiquidateHealthyLoan
            );
