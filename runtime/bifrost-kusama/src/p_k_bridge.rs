...
use bifrost_primitives::{
	AccountId, AssetHubPolkadotGlobalLocation, Balance, BifrostKusamaGlobalLocation,
	BifrostKusamaLocation, BifrostPolkadotLocation, RemoteBifrostKusamaBncLocation,
};
...
ord_parameter_types! {
	pub const BifrostPolkadotGlobalSovereignAccount: AccountId = AccountId::new(hex2array!("77fae120a39b5b06bad879e2d7badb397728db14dafd71e728179822f382f481"));
}

pub struct TransferTokensToPolkadot;

impl PKBridgeTransferTokens for TransferTokensToPolkadot {
	...
	fn transfer_tokens(
		...
		let remote_xcm = sibling_asset_hub_xcm(
			...
			(RemoteBifrostKusamaBncLocation::get(), fees.hop1).into(),
			BifrostKusamaLocation::get(),
			BifrostKusamaGlobalLocation::get(),
